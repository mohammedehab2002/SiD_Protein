...
--min_n_res 30 \
--max_n_res 270 \
--resume 'protein_experiment/sid-train-runs/proteina_multistep/00046-uncond-proteina-glr5e-05-lr0.0001-initsigma2.5-gpus8-alpha1.0-batch4096-tmax0.98-fp16-nstep1/training-state-003739.pt' \
