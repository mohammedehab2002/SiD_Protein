...
from training.proteina.evaluations.inverse_fold_models.model import InverseFoldModel

import sys
sys.path.append('./packages')

from packages.ProteinMPNN.protein_mpnn_utils import (
	_scores,
	_S_to_seq,
	tied_featurize,
	parse_PDB
)
from packages.ProteinMPNN.protein_mpnn_utils import ProteinMPNN as ProteinMPNNBase
from packages.ProteinMPNN.protein_mpnn_utils import StructureDatasetPDB
