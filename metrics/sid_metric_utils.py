...
class MetricOptions:
    def __init__(self, G=None, init_sigma=None, G_kwargs={}, network_kwargs={}, dataset_kwargs={}, data_stat=None, num_gpus=1, rank=0, local_rank=0, device=None, progress=None, cache=True):
        assert 0 <= rank < num_gpus
        
        self.G              = G
        self.G_kwargs       = dnnlib.EasyDict(G_kwargs)
        self.init_sigma = init_sigma
        self.network_kwargs = dnnlib.EasyDict(network_kwargs)
